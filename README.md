...
Simulando a tela de um dispositivo mobile, o jogo é exibido em um display de resolução 600x800 pixels, e tem como objetivo central que o jogador recolha pelo menos cinco coletáveis de cada tipo (coca-café, marmita e salgado), enquanto atravessa as pistas do cenário e evita ao máximo a colisão com os veículos. O contato com qualquer um dos veículos leva a volta do jogador à posição inicial e à perda de um ponto de vida, de um total de três vidas disponíveis.
