...
3. Download e extração, em uma pasta de preferência, do .zip associado à branch 'main' do repositório desta página; **OU**
4. Clonagem do repositório Git, em um diretório de preferência, utilizando o comando `git clone https://github.com/filipecml/Projeto-IP.git` no terminal da sua máquina; e
5. Execução do arquivo _main.py_, acessando a pasta no prompt de comando (`python main.py`) ou em seu editor de preferência.
